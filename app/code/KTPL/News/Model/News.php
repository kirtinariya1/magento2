<?php
namespace KTPL\News\Model;

/**
 * News Model
 *
 * @method \KTPL\News\Model\ResourceModel\News _getResource()
 * @method \KTPL\News\Model\ResourceModel\News getResource()
 */
class News extends \Magento\Framework\Model\AbstractModel
{
    ...
    {
        $this->_init('KTPL\News\Model\ResourceModel\News');
    }
