...
class News extends \Magento\Framework\View\Element\Template
{
     ...
     * News collection
     *
     * @var KTPL\News\Model\ResourceModel\News\Collection
     */
     ...
     * News factory
     *
     * @var \KTPL\News\Model\NewsFactory
     */
    protected $_newsCollectionFactory;
    
    /** @var \KTPL\News\Helper\Data */
    protected $_dataHelper;
    
    /**
     * @param \Magento\Framework\View\Element\Template\Context $context
     * @param \KTPL\News\Model\Resource\News\CollectionFactory $newsCollectionFactory
	 * @param \KTPL\News\Helper\Data $dataHelper
     * @param array $data
     */
    public function __construct(
        \Magento\Framework\View\Element\Template\Context $context,
        \KTPL\News\Model\ResourceModel\News\CollectionFactory $newsCollectionFactory,
        \KTPL\News\Helper\Data $dataHelper,
        array $data = []
    ) {
     ...
     *
     * @return KTPL_News_Model_ResourceModel_News_Collection
     */
     ...
     *
     * @return KTPL_News_Model_Resource_News_Collection
     */
     ...
     *
     * @param KTPL_News_Model_News $newsItem
     * @return string
     */
     ...
     *
     * @param KTPL_News_Model_News $item
     * @param integer $width
     * @return string|false
     */
